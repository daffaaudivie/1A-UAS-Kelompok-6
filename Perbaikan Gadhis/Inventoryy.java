...
public class Inventoryy {
    ...
    public static void main(String[] args) {
        ...
        do {
            ...
            switch (pilih) {
                ...
                case 0:
                    ...
                    System.out.print("Apakah anda yakin ingin keluar? (Y/T) : ");// menampilkan
                    String a = sc.next();
        ...
        // Ekspresi logika
        while (true); // mengevaluasi
    }

    static void dataBarang() {
        System.out.print("Masukkan jumlah barang \t: ");
        jumlah = sc.nextInt();
        namaBarang = new String[jumlah];
    ...
    static void barangMasuk() {
        ...
        System.out.println("Jumlah barang yg masuk:");
        for (int i = 0; i < namaBarang.length; i++) {
